...
class Trip(Base):
    ...
    to_place: Mapped[Coordinates] = mapped_column(JSON(), nullable=False)
    from_place: Mapped[Coordinates] = mapped_column(JSON(), nullable=False)
    ...
    route: Mapped[Route] = mapped_column(JSON(), nullable= False)
